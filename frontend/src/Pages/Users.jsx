...
const Users = ( {isDark } ) => {
    ...
    return (
        <div className="w-[65%] flex flex-col h-auto items-center mt-1">
              ...
              filtredUsers.map((user, index) => (
                <>
                  <div
                    ...
                    className={
                      isDark
                        ? "w-full flex items-center justify-center bg-[#283340] mt-1 py-1"
                        : "w-full flex items-center justify-center bg-[#fff] mt-1 py-1"
                    }
                  >
                    <div
                      className={
